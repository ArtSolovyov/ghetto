...
const Form = (props) => {
    ...
    return (
        ...
        <Input autoComplete='on' className='nameInput' placeholder="Никнейм" style={{width: '176px', margin: '1.5rem 0rem 0rem 1rem', display: 'inline-block'}} />
        <Input autoComplete='on' className='idInput' placeholder="Battle.net ID" style={{width: '115px', margin: '1.5rem 1rem 0rem 0.5rem', display: 'inline-block'}} />
